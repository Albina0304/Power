                            ...
                            <div id="footer-nav-1">
                                <span class="footer-colon-accordion" type="button" data-bs-toggle="collapse" data-bs-target="#footer-item-1" aria-expanded="false" aria-controls="footer-item-1">
                                    <h5 class="footer-bottom-title-accordion">
                                        ...
                                        <span class="footer-plus"><svg version='1.1' xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 20 20'><path d='M17.418 6.109c0.272-0.268 0.709-0.268 0.979 0s0.271 0.701 0 0.969l-7.908 7.83c-0.27 0.268-0.707 0.268-0.979 0l-7.908-7.83c-0.27-0.268-0.27-0.701 0-0.969s0.709-0.268 0.979 0l7.419 7.141 7.418-7.141z'></path></svg></span>
                                    </h5>
                                </span>
                            </div>
